...
class CatchException extends AppException {
  const CatchException(super.message);

  @override
  Failure toFailure() => Failure(
    type: FailureType.unknown,
    message: message.isNotEmpty ? message : 'Failed to access catch.',
  );
}
...
class DependencyException extends AppException {
  ...
  Failure toFailure() => Failure(
    type: FailureType.unknown,
    message: message.isNotEmpty ? message : 'Dependency error occured.',
  );
}
